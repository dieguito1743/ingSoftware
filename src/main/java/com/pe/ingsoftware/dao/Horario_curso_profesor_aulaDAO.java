...
public class Horario_curso_profesor_aulaDAO implements IBDCrud<Horario_curso_profesor_aulaDTO> {
    ...
    @Override
    public Horario_curso_profesor_aulaDTO consultarUno(Object campo, Object valorCampo, int tipoCampo) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    @Override
    public ArrayList<Horario_curso_profesor_aulaDTO> consultarTodoDe(Object campo, Object valorCampo, int tipoCampo) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
