...
public class Horas_cursosDAO implements IBDCrud<Horas_cursosDTO> {
    ...
    @Override
    public Horas_cursosDTO consultarUno(Object campo, Object valorCampo, int tipoCampo) {
    ...
    @Override
    public ArrayList<Horas_cursosDTO> consultarTodoDe(Object campo, Object valorCampo, int tipoCampo) {
        ArrayList<Horas_cursosDTO> ArrayList = new ArrayList();
